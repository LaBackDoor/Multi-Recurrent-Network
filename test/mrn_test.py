...
model_1 = MRN(
    nn_structure=nn_structure_1,
    memory_structure=memory_structure_1
)
...
model_2 = MRN(
    nn_structure=nn_structure_2,
    memory_structure=memory_structure_2
)
...
model_3 = MRN(
    nn_structure=nn_structure_3,
    memory_structure=memory_structure_3
)
...
for layer_idx, act in activations.items():
    layer_type = "Input" if layer_idx == 0 else ("Output" if layer_idx == model_2.num_layers - 1 else f"Hidden {layer_idx}")
